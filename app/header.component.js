System.register(['angular2/core', './header.service', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, header_service_1, router_1;
    var HeaderComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            HeaderComponent = (function () {
                function HeaderComponent(_headerService) {
